import { connectToHtp1 } from './websocket';
...
if (!argv.htp1Address) {
  ...
  console.log(
    'Optionally takes --telnetPort=xxx with the address to serve at (defaults to 23)'
  );
  exit();
}
...
const telnetPort: number = argv.telnetPort ?? 23;
